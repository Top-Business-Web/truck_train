			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="m-portlet">
						...
						<!--begin::Form-->
						<form class="m-form" method="post" action="{{route('createAdmin')}}" enctype="multipart/form-data">
                            @csrf
							<div class="m-portlet__body">
								<div class="m-form__section m-form__section--first">
									<div class="form-group m-form__group row">
										...
										<div class="col-lg-6">
											<input type="text" class="form-control m-input" placeholder="{{__('messages.Enter full name')}}" name="name">
											@error('name')
                                    ...
                                    <div class="form-group m-form__group row">
										...
										<div class="col-lg-6">
											<input type="file" class="form-control m-input dropify" name="logo" />
											@error('logo')
                                                <span class="m-form__help text-danger">{{$message}}</span>
                                            @enderror
										</div>
