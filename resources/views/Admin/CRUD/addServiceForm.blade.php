    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
    	...
    	<div class="m-subheader ">
    		<div class="d-flex align-items-center">
    			<div class="mr-auto">
    				<h3 class="m-subheader__title m-subheader__title--separator">{{__('messages.addService')}}</h3>
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="m-portlet">
						...
						<!--begin::Form-->
						<form class="m-form" method="post" action="{{route('createService')}}" enctype="multipart/form-data">
                            @csrf
							<div class="m-portlet__body">
								<div class="m-form__section m-form__section--first">
                                    ...
                                    <div class="form-group m-form__group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control m-input" placeholder="" name="title_en">
                                            @error('title')
                                            <span class="m-form__help text-danger">{{$message}}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group m-form__group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control m-input" placeholder="" name="title_ur">
                                            @error('title')
                                            <span class="m-form__help text-danger">{{$message}}</span>
                                            @enderror
                                        </div>
