        ...
        if (window.File && window.FileReader && window.FileList && window.Blob) {
            var s = {
                ...
                tpl: {
                    ...
                    message: '<div class="card-text file-upload-message"><i class="fas fa-user"></i><p>{{ default }}</p></div>',
                    ...
                    clearButton: '<button type="button" class="btn btn-sm btn-danger"><i class="far fa-trash-alt"></i></button>',
